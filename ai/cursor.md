...
##### 让ai按“带具体入参的调试视角”给你拆解

用 $trace-code-explainer 解释这个函数：



##### 日报总结

用 $daily-report-git-summary 按我上一次日报到这次之间的改动，生成一份简洁日报和提交记录

解释概念：见名知义 -> 一句话定义 -> 通俗例子 -> 容易混淆点 -> 记忆句 -> 可选文本流程图。你以后可以直接这样用：使用$plain-zh-concept-explainer
